---
title: "Extending NIMBLE: Writing new functions and distributions to use in models"
...
\[
P(y[i,1\colon J] ~|~ \psi, p[i, 1\colon J]) = \psi \prod_{j=1}^J \mbox{dbern}(y[i,j] ~|~ p[i,j]) + (1-\psi) I(\mbox{all } y[i, j] \mbox{ = 0})
\]
